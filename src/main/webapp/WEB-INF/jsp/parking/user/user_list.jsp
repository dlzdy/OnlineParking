	...
	<form action="" name="" id="" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				...
				<td><input style="width:95%;" type="text" name="name" id="name" value="" maxlength="500" placeholder="请输入姓名" title=""/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">年龄:</td>
				<td><input style="width:95%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入年龄" title=""/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input style="width:95%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入职务" title=""/></td>
			</tr>
			
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">邮箱:</td>
				<td><input style="width:95%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入邮箱" title=""/></td>
			</tr>
			<tr>

...
<body>
	<form action="" name="" id="" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:75px;text-align: right;padding-top: 13px;">设备ID:</td>
				<td><input style="width:93%;" type="text" name="" id="" value="" maxlength="500"  readonly="readonly"/></td>
			</tr>
			<tr>
				<td style="width:75px;text-align: right;padding-top: 13px;">所属停车场:</td>
				<td><input style="width:93%;" type="text" name="" id="" value="" maxlength="500" readonly="readonly"/></td>
			</tr>
			<tr>
				<td style="width:75px;text-align: right;padding-top: 13px;">可用状态:</td>

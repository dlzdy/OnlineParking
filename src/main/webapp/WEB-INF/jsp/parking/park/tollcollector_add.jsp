	...
	<form action="" name="" id="" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				...
				<td><input style="width:93%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入手机号" title=""/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">密码:</td>
				<td><input style="width:93%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入密码" title=""/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">卡号:</td>
				<td><input style="width:93%;" type="text" name="" id="" value="" maxlength="500" placeholder="请输入卡号" title=""/></td>
			</tr>
			<tr>

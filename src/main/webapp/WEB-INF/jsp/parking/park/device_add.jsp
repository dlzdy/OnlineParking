...
<body>
	<form action="" name="" id="" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">所属停车场:</td>
				<td><input style="width:95%;" type="text" name="name" id="name" value="" maxlength="500" readonly="readonly"/></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">可用状态:</td>
				<td><select style="width:100%;" type="text" name="" id="" value="" maxlength="500" placeholder="请选择姓名" title="">
					<option></option>
					<option value="" name="">可用</option>
					<option>不可用</option>
				</select></td>
			</tr>
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">收费员:</td>
				<td><input style="width:95%;" type="text" name="" id="" value="" maxlength="500" placeholder="" title=""/></td>
			</tr>
			<tr>

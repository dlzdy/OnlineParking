...
<html lang="en">
	...
	<!-- basic styles -->
	<link href="system/css/bootstrap.min-3.0.0.css" rel="stylesheet" />
	...
	<style>
		...
		/* .col-xs-2{width:16.4%;float:left;margin-left:1px;margin-top:-1px;text-align:center} */
		.wrap-box { position: relative;}
		.plate-box::before {border: 1px solid #fff;border-radius: 3px; bottom: 0;content: "";height: 72.22%;left: 0;
    margin: auto;
    position: absolute;
    right: 0;
    top: 0;
...
.plate-box {
 ...
 .bg-blue{ background-color: #15a4fa}
	</style>
<body>
...
<div class="container-fluid" id="main-container">
	<div id="page-content" class="clearfix">
		<div id="breadcrumbs">
			<ul class="breadcrumb">
			<li><i class="icon-home"></i> 首页<span class="divider"><i class="icon-angle-right"></i></span>充电桩</li>
		</ul>
	</div><!--#breadcrumbs-->
			...
			<table id="table_report" class="table table-striped table-bordered table-hover">
				...
				<tbody id="t_datas">
					<tr>
						...
						<td class="center"></td>
						<td class="center">
							<a style="cursor:pointer;" title="删除" onclick="del('确定要删除选中的数据吗?');"><span class="red"><i class="icon-trash"></i></span></a>
						</td>
					</tr>
					<tr>
